...
The operations engineering team has created a dynamic compliance badge that you can add to your repository's README file. This badge indicates whether a repository meets the Ministry of Justice's [GitHub Repository Standards](https://user-guide.operations-engineering.service.justice.gov.uk/documentation/information/mojrepostandards.html).
